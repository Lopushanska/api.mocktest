...
module TestRail
  class APIClient
    ...
    def initialize
      @base_url = 'https://digitalturbine.testrail.net/'
      @user = 'anastasiia.lopushanska@digitalturbine.com'
      @password = 'Nastenkaa22'
      @project_id = 16
      @results = []
      @url = @base_url + 'index.php?/api/v2/'
    end

    def add_run(suite_id, test_run_name, section_id=nil)
      ...
      send_post("add_run/#{project_id}", data)['id']
    end
